# Freely based on: https://github.com/okp4/template-go/blob/main/Makefile

# Constants
BINARY_NAME             = indeks-api
...
.PHONY: all lint lint-go build build-go help generate generate-graphql
